...
| `/activity` | GET | None | In-memory scan, watcher and maintenance operations, each naming its root or `null` when spanning several; see [System activity](SYSTEM-ACTIVITY.md). No storage scans. |
