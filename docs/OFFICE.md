...
ONLYOFFICE is bundled with the standard fdrive stack, and it is the document server the
published images support. Enable Office during onboarding, or later in
