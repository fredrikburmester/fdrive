...
ALTER TABLE "app"."office_files" ADD CONSTRAINT "office_files_provider_id_providers_id_fk" FOREIGN KEY ("provider_id") REFERENCES "app"."providers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
